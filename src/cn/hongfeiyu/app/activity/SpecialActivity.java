...
import cn.hongfeiyu.api.bean.SpecialItme;
import cn.hongfeiyu.api.bean.hongfeiyuDataBaseSpecial;
import cn.hongfeiyu.app.R;
import cn.hongfeiyu.app.adapter.SpecialFragmentPagerAdapter;
		...
		MyHttpAPIControl.newInstance().getSpecial(item.getContentid(),
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, String content) {
						...
						Type tp = new TypeToken<hongfeiyuDataBaseSpecial>() {
						}.getType();
						hongfeiyuDataBaseSpecial ss = (hongfeiyuDataBaseSpecial) ParseUtils
