...
import cn.hongfeiyu.api.DownloadWebImgTask;
import cn.hongfeiyu.api.MyHttpAPIControl;
import cn.hongfeiyu.api.ParseUtils;
import cn.hongfeiyu.api.bean.ArticleItme;
import cn.hongfeiyu.api.bean.PhotosItem;
import cn.hongfeiyu.api.bean.PhotosItem.ImageData;
import cn.hongfeiyu.api.bean.PhotosItem.PhotoData;
import cn.hongfeiyu.app.R;
import cn.hongfeiyu.app.adapter.PhotosActivityAdapter;
import cn.hongfeiyu.app.util.DateUtils;
import cn.hongfeiyu.app.util.DialogUtils;
import cn.hongfeiyu.app.util.SharedPMananger;
import cn.hongfeiyu.app.widget.OnChangedListener;
import cn.hongfeiyu.app.widget.SlipButton;
...
public class PhotosActivity extends FragmentActivity implements
	...
	private void setListData(PhotoData data) {
		view = View.inflate(mInstance, R.layout.hongfeiyu_listview_head, null);
