package cn.hongfeiyu.app.activity;
...
import cn.hongfeiyu.api.bean.Category;
import cn.hongfeiyu.api.bean.hongfeiyuDataBase;
import cn.hongfeiyu.app.R;
import cn.hongfeiyu.app.adapter.DragAdapter;
import cn.hongfeiyu.app.adapter.OtherAdapter;
import cn.hongfeiyu.app.util.ApplicationUtil;
import cn.hongfeiyu.app.util.SharedPMananger;
import cn.hongfeiyu.app.widget.DragGrid;
import cn.hongfeiyu.app.widget.DragGrid.Exchangelistenter;
import cn.hongfeiyu.app.widget.OtherGridView;
...
public class ChannelActivity extends Activity implements OnItemClickListener,
	...
	private hongfeiyuDataBase<Category> mHongfeiyuDataBase;
	...
	private void initNaigation(String json) {
		Type tp = new TypeToken<hongfeiyuDataBase<Category>>() {
		}.getType();
		mHongfeiyuDataBase = (hongfeiyuDataBase<Category>) ParseUtils.Gson2Object(json,
				tp);
		if (mHongfeiyuDataBase != null && mHongfeiyuDataBase.isState()) {
			ArrayList<Category> naviga = mHongfeiyuDataBase.getData();
	...
	private void saveChannel() {
		if (mHongfeiyuDataBase != null) {
			ArrayList<Category> data = mHongfeiyuDataBase.getData();
			data.clear();
			data.addAll(userAdapter.getChannnelLst());
			data.addAll(otherAdapter.getChannnelLst());
			String object2Json = ParseUtils.Object2Json(mHongfeiyuDataBase);
