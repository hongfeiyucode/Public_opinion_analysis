...
public class hongfeiyuApplication extends Application {
	private static hongfeiyuApplication mApp;

	public static hongfeiyuApplication getInstance() {
		return mApp;
	}
