package cn.hongfeiyu.app.fragment;
...
import cn.hongfeiyu.api.MyHttpAPIControl;
import cn.hongfeiyu.api.ParseUtils;
import cn.hongfeiyu.api.bean.ArticleItme;
import cn.hongfeiyu.api.bean.hongfeiyuDataBase;
import cn.hongfeiyu.app.Constants;
import cn.hongfeiyu.app.R;
import cn.hongfeiyu.app.activity.NewsActivity;
import cn.hongfeiyu.app.activity.PhotosActivity;
import cn.hongfeiyu.app.activity.SpecialActivity2;
import cn.hongfeiyu.app.adapter.ArticleAdapter;
import cn.hongfeiyu.app.adapter.PictureScrollPagerAdapter;
import cn.hongfeiyu.app.util.ResourceUtil;
import cn.hongfeiyu.app.util.ScreenSizeUtil;
import cn.hongfeiyu.pulltorefresh.library.PullToRefreshBase;
import cn.hongfeiyu.pulltorefresh.library.PullToRefreshBase.Mode;
import cn.hongfeiyu.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2;
import cn.hongfeiyu.pulltorefresh.library.PullToRefreshListView;
...
public class ArticlePageFragment extends Fragment {
	...
	private void initHeadView() {
		...
		View mHeadView = mLayoutInflater.inflate(
				R.layout.hongfeiyu_layout_list_head_view, null);
		...
		MyHttpAPIControl.newInstance().getNewsList(mTag_id, page,
				article_last_time, new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, String content) {
						...
						mPullListView.onRefreshComplete();
						Type tp = new TypeToken<hongfeiyuDataBase<ArticleItme>>() {
						}.getType();
						hongfeiyuDataBase<ArticleItme> ss = (hongfeiyuDataBase<ArticleItme>) ParseUtils
